...
class VitrolifeClient(fl.client.NumPyClient):
    def __init__(self, client_id, number_of_rounds, number_of_epochs, experiment_name,  balancing_strategy, use_data_augmentor, batch_size):
        ...
        self.training_generator = DataLoader.VitroLifeDataloader("/mnt/data/vitroLifeDataset", self.batch_size , dataset_split="Train", data_augmentation = self.use_data_augmentor, balancing_strategy=self.balancing_strategy, clinic_ID = self.client_id)
